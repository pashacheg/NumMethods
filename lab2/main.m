function r=main(a,b)
  ...
  figure(2)
  logerror(X1,Y1, n1, a,b, M, 1,0);
  logerror(X2,Y2, n2, a,b, M, 1,0);
  logerror(X3,Y3, n3, a,b, M, 1,0);
  grid on
