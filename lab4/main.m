function r=main(a, b)
  ...
  plot(M, dE5)
  grid on
  leg = legend("h=0.1","h=0.05","h=0.025","h=0.01","h=0.0", "location", "southeast");
  set (leg, "fontsize", 16);
  ...
  figure(4)
  plot(H, [dmax1 dmax2 dmax3 dmax4 dfmax], "g")
  hold on
  plot(H, [ddmax1 ddmax2 ddmax3 ddmax4 ddfmax], "b")
  hold on
  plot(H, [dmax1 dmax2 dmax3 dmax4 dfmax], "rx")
  hold on
  plot(H, [ddmax1 ddmax2 ddmax3 ddmax4 ddfmax], "ks")
  grid on  
  leg = legend("f'(x)", "f''(x)", "location", "southeast");
  set (leg, "fontsize", 16);
